#######################################################################################################################
##  DAG_NAME :  ingest_chargers
##  PURPOSE :   DAG to load data from source to ingest for chargers
...
SOURCE_DB_NAME = 'chargers'
DAG_TITLE = 'ingest_chargers'
SCHEDULE = Variable.get("chargers_ingest_schedule", default_var='') or None
