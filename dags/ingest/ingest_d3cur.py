#######################################################################################################################
##  DAG_NAME :  ingest_d3cur_calls
##  PURPOSE :   DAG to load data from source to ingest for d3cur
##  PREREQUISITE DAGs :
#######################################################################################################################
...
SOURCE_DB_NAME = 'd3cur'
DAG_TITLE = 'ingest_d3cur_calls'
SCHEDULE = Variable.get("d3cur_calls_ingest_schedule", default_var='') or None
