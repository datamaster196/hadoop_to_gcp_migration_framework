#######################################################################################################################
##  DAG_NAME :  ingest_d3
##  PURPOSE :   DAG to load data from source to ingest for d3
...
SOURCE_DB_NAME = 'd3'
DAG_TITLE = 'ingest_d3'
SCHEDULE = Variable.get("d3_ingest_schedule", default_var='') or None
...
#    task_id="integrated_ers",
#    trigger_dag_id="integrated_ers",  # Ensure this equals the dag_id of the DAG to trigger
#    conf={"message": "integrated_ers has been triggered"},
#    dag=dag)
