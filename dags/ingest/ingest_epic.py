#######################################################################################################################
##  DAG_NAME :  ingest_epic
##  PURPOSE :   DAG to load data from source to ingest for epic
...
SOURCE_DB_NAME = 'epic'
DAG_TITLE = 'ingest_epic'
SCHEDULE = Variable.get("epic_ingest_schedule", default_var='') or None
...
#    task_id="integrated_insurance",
#    trigger_dag_id="integrated_insurance",  # Ensure this equals the dag_id of the DAG to trigger
#    conf={"message": "integrated_insurance has been triggered"},
#    dag=dag)
