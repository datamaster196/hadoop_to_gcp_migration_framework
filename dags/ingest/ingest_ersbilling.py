#######################################################################################################################
##  DAG_NAME :  ingest_ersbilling
##  PURPOSE :   DAG to load data from source to ingest for ersbilling
...
SOURCE_DB_NAME = 'ersbilling'
DAG_TITLE = 'ingest_ersbilling'
SCHEDULE = Variable.get("ersbilling_ingest_schedule", default_var='') or None
