#######################################################################################################################
##  DAG_NAME :  ingest_history_aca_store
##  PURPOSE :   DAG to load data from source to ingest for ACA Store
...
SOURCE_DB_NAME = 'eds'
DAG_TITLE = 'ingest_history_aca_store'
SCHEDULE = Variable.get("eds_ingest_schedule", default_var='') or None
...
dag = DAG(DAG_TITLE, default_args=default_args, schedule_interval=SCHEDULE, max_active_runs=1)
