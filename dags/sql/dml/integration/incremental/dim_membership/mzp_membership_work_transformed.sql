...
SELECT
    ...
    CASE when membership.temp_addr_ind is null then 'U'
    else membership.temp_addr_ind end as mbrs_temporary_address_ind,
    ...
    CASE when membership.ebill_fl is null then 'U'
    else membership.ebill_fl end as mbrs_ebill_ind,
