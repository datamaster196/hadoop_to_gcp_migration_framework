create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.vast_contact_target_work` as 
--vast key target records
select
contact_adw_key as contact_adw_key,

source_1_key as vast_cust_nbr,
source_2_key as company,
