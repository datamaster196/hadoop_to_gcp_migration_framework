create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.d3_contact_address_stage` as
...
USING
  `{{ var.value.INTEGRATION_PROJECT }}.adw_work.d3_contact_address_stage` source
ON
...
END
  ...
  AND target.contact_source_system_nm='d3' THEN
DELETE;
