create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.d3_contact_target_work` as 

select 
d3_keys.contact_adw_key as contact_adw_key,
...
from
`{{ var.value.INTEGRATION_PROJECT }}.adw.dim_contact_source_key` d3_keys
   where d3_keys.contact_source_system_nm='d3'
    and d3_keys.key_typ_nm='service_call_key'
