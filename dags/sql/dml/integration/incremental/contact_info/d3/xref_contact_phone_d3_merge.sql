create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.d3_contact_phone_stage` as
...
using `{{ var.value.INTEGRATION_PROJECT }}.adw_work.d3_contact_phone_stage` source
