create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.pos_contact_name_stage` as
...
using `{{ var.value.INTEGRATION_PROJECT }}.adw_work.pos_contact_name_stage` source
