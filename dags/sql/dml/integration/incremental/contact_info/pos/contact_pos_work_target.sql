create or replace table `{{ var.value.INTEGRATION_PROJECT }}.adw_work.pos_contact_target_work` as 

select 
pos_keys.contact_adw_key as contact_adw_key,
pos_keys.source_1_key as pos_cust_id,
'' as iso_cd,
'' as club_cd,
'' as membership_id,
'' as associate_id,
...
from
`{{ var.value.INTEGRATION_PROJECT }}.adw.dim_contact_source_key` pos_keys
    WHERE pos_keys.contact_source_system_nm='pos'
    and pos_keys.key_typ_nm='pos_cust_id'
