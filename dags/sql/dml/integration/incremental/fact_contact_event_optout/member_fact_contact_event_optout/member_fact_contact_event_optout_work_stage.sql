CREATE OR REPLACE TABLE
  `{{ var.value.INTEGRATION_PROJECT }}.adw_work.member_fact_contact_event_optout_work_stage` AS
SELECT
  ...
  source.event_dtm
FROM
  `{{ var.value.INTEGRATION_PROJECT }}.adw_work.member_fact_contact_event_optout_work_transform` source
LEFT JOIN
