  ...
  USING
    `{{ var.value.INTEGRATION_PROJECT }}.adw_work.dim_cont_segm_sig_work_stage` b
  ON
    (a.contact_adw_key = b.contact_adw_key and a.segment_source = b.segment_source and a.segment_panel = b.segment_panel and a.segment_cd = b.segment_cd
