CREATE OR REPLACE TABLE
  ...
  SELECT
    ...
    CASE when membership_source.temp_addr_ind is null then 'U'
    else membership_source.temp_addr_ind end as temp_addr_ind,
  ...
  --  membership_source.coverage_level_ky,
     CASE when membership_source.ebill_fl is null then 'U'
    else membership_source.ebill_fl end as ebill_fl,
