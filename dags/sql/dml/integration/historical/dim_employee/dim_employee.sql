...
USING
  `{{ var.value.INTEGRATION_PROJECT }}.adw_work.employee_work_stage` b
ON
  a.emp_adw_key=b.emp_adw_key
  AND a.effective_start_datetime = b.effective_start_datetime
  WHEN NOT MATCHED THEN INSERT ( emp_adw_key, active_directory_email_adw_key, email_adw_key, phone_adw_key, fax_phone_adw_key, nm_adw_key, emp_typ_cd, emp_active_directory_user_id , emp_hr_id , emp_hr_hire_dt, emp_hr_term_dt, emp_hr_term_reason, emp_hr_status, emp_hr_region, emp_loc_hr, emp_hr_title, emp_hr_sprvsr, emp_hr_job_cd, emp_hr_cost_center, emp_hr_position_typ, effective_start_datetime, effective_end_datetime, actv_ind, integrate_insert_datetime, integrate_insert_batch_number, integrate_update_datetime, integrate_update_batch_number, adw_row_hash ) VALUES ( b.emp_adw_key, b.active_directory_email_adw_key, b.email_adw_key, b.phone_adw_key, b.fax_phone_adw_key, b.nm_adw_key, b.emp_typ_cd, b.emp_active_directory_user_id , b.emp_hr_id , b.emp_hr_hire_dt, b.emp_hr_term_dt, b.emp_hr_term_reason, b.emp_hr_status, b.emp_hr_region, b.emp_loc_hr, b.emp_hr_title, b.emp_hr_sprvsr, b.emp_hr_job_cd, b.emp_hr_cost_center, b.emp_hr_position_typ, b.effective_start_datetime, b.effective_end_datetime, b.actv_ind, b.integrate_insert_datetime, b.integrate_insert_batch_number, b.integrate_update_datetime, b.integrate_update_batch_number, b.adw_row_hash )
  WHEN MATCHED
  THEN
UPDATE
SET
