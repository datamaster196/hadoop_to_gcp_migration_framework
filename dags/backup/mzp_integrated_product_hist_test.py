...
DAG_TITLE = "integrated_membership_payment_summary_hist_test5"
...
with DAG(DAG_TITLE, default_args=default_args, schedule_interval=None) as dag:
    ...
    #summary
    task_payment_applied_summary_hist_source >> task_payment_applied_summary_hist_transformed
    task_payment_applied_summary_hist_transformed >> task_payment_applied_summary_work_type2_logic
    task_payment_applied_summary_work_type2_logic >> task_payment_applied_summary_insert 